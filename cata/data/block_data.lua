...
addBlock("f_door_c",32*0,32*9,32,32,"fitment",2);setLast(tl("关闭的木门","close wood door"),moveblock,"brown",false,nil);autoFlags{"NOITEM"}
...
addBlock("f_window",32*2,32*9,32,32,"fitment",1);setLast(tl("窗户","window"),moveblock,"light_blue",true,{resetTM = true});autoFlags{"NOITEM"}
addBlock("f_window_open",32*3,32*9,32,32,"fitment",1);setLast(tl("打开的窗户","open window"),250,"light_blue",true,{resetTM = true});autoFlags{"NOITEM"}
...
addBlock("f_wood_chair2",32*8,32*9,32,32,"furnitrue",1);setLast(tl("木椅","wood chair"),50,"brown",true,{rotate = {"f_wood_chair3","f_wood_chair4","f_wood_chair1"}});autoFlags{"ITEM_ON_TOP"}
addBlock("f_wood_chair4",32*9,32*9,32,32,"furnitrue",1);setLast(tl("木椅","wood chair"),50,"brown",true,{rotate = {"f_wood_chair1","f_wood_chair2","f_wood_chair3"}});autoFlags{"ITEM_ON_TOP"}
addBlock("f_wood_chair1",32*8,32*10,32,32,"furnitrue",1);setLast(tl("木椅","wood chair"),50,"brown",true,{rotate = {"f_wood_chair2","f_wood_chair3","f_wood_chair4"}});autoFlags{"ITEM_ON_TOP"}
addBlock("f_wood_chair3",32*9,32*10,32,32,"furnitrue",1);setLast(tl("木椅","wood chair"),50,"brown",true,{rotate = {"f_wood_chair4","f_wood_chair1","f_wood_chair2"}});autoFlags{"ITEM_ON_TOP"}
addBlock("f_chair",32*9,32*8,32,32,"furnitrue",1);setLast(tl("椅子","chair"),50,"dark_brown",true,nil) ;autoFlags{"CONTAINER"}
addBlock("f_armchair",32*8,32*8,32,32,"furnitrue",1);setLast(tl("扶手椅","arm chair"),50,"dark_red",true,nil);autoFlags{"CONTAINER"}
...
addBlock("f_nighttable",32*2,32*15,32,32,"furnitrue",1);setLast(tl("床头柜","bedside table"),100,"brown",true,nil);autoFlags{"CONTAINER"}
addBlock("f_cupboard",32*0,32*16,32,32,"furnitrue",1);setLast(tl("碗柜","cupboard"),100,"dark_blue",true,nil) ;autoFlags{"ITEM_ON_TOP"}
...
addBlock("f_bathtub",32*4,32*16,32,32,"furnitrue",1);setLast(tl("浴缸","bathtub"),100,"white",true,nil);autoFlags{"ITEM_ON_TOP"}
addBlock("f_toilet",32*5,32*16,32,32,"furnitrue",1);setLast(tl("马桶","toilet"),100,"white",true,nil);autoFlags{"CONTAINER"}
...
addBlock("f_dumpster",32*2,32*19,32,32,"furnitrue",1);setLast(tl("垃圾箱","dumpster"),150,"dark_green",true,nil);autoFlags{"CONTAINER"}
return block_data