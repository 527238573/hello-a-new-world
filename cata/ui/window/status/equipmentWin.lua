...
local function drawBack(x,y,w,h)
  ...
  --love.graphics.setColor(173,190,221)
  ...
  --love.graphics.setColor(183,186,210)
  --love.graphics.setColor(16,18,36)
...
local function printOnePart(base,add,all,warm,x,y)
  ...
  if all>5 then
    love.graphics.setColor(128,40,40)
  elseif all>1 then
  ...
  if warm>5 then
    love.graphics.setColor(128,40,40)
  elseif warm>1 then
    love.graphics.setColor(128,128,80)
  else
    love.graphics.setColor(92,92,92)
  end
...
local function encumberance_info(x,y)
  --love.graphics.setColor(18,18,40,200)
