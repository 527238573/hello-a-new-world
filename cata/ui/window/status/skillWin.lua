...
local function drawBack_list(x,y,w,h)
  love.graphics.setColor(233,233,255)
...
local function one_skill(num,x,y,w,h)
  ...
  elseif select_skill_index==num then
    love.graphics.setColor(210,147,111,150)
    love.graphics.rectangle("fill",x,y,w,h)
  end
  ...
  love.graphics.setColor(22,122,122)
  --love.graphics.setColor(22,math.min(level*20,255),math.min(level*10,255))
