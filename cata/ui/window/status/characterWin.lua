...
local function drawHpbar(hp,maxhp,x,y,w,h)
  love.graphics.setColor(143,59,59)
  love.graphics.rectangle("fill",x,y,w,h)
  if hp>0 then
    local hplen = hp/maxhp*(w-4)
    love.graphics.setColor(121,213,68)
...
local function setValColor(val,base)
  ...
  elseif val>base then
    love.graphics.setColor(11,129,11)
  else
    love.graphics.setColor(142,22,22)
  end
end

local function drawBack(x,y,w,h)
  
  love.graphics.setColor(183,186,210)
...
local function oneTrait(num,x,y,w,h)
  ...
  if state =="hovered" then
    love.graphics.setColor(111,147,210,150)
    love.graphics.rectangle("fill",x,y,w,h)
  end
  if curTrait:is_good() then
    love.graphics.setColor(22,102,22)
  else
    love.graphics.setColor(102,22,22)
  end
  love.graphics.setFont(c.font_c16)
