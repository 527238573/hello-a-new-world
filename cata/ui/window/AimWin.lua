...
function load_panel_text()
  ...
  addOneLineInfo{{170,170,170},string.format("%s%.1f","瞄准目标  距离:",dist),}
  addOneLineInfo{{170,170,170},"子弹数:xx/xx",}
  length = length+20
  
  
  addOneLineInfo{{210,210,210},"一些目标信息  敌对的？",}
  addOneLineInfo{{210,210,210},"受伤状态",}
  addOneLineInfo{{210,210,210},"很多的字，目标描述很多的字，目标描述很多的字，目标描述很多的字，目标描述很多的字，目标描述很多的字，目标描述很多的字，目标描述",}
  length = length+20
  
  for _,v in ipairs(default_text) do
    addOneLineInfo{{170,170,170},v,}
  end
  ptextlength = length
end
