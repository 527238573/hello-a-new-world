...
local function drawBack()
  if is_pickingup then
    love.graphics.setColor(218,218,248)
  else
    love.graphics.setColor(248,218,218)
  end
  ...
  if cur_weight>max_weight then
    love.graphics.setColor(176,23,43)
  else
...
local function drawOneItem(num,curItem,opt, x,y,w,h)
  if opt.state =="active" then
    love.graphics.setColor(111,147,210)
    love.graphics.rectangle("fill",x,y,w,h)
  elseif num == curSelectIndex then
    love.graphics.setColor(147,169,210)
    love.graphics.rectangle("fill",x,y,w,h)
