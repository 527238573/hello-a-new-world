...
local arrow_img = love.graphics.newImage("assets/ui/directionArrow.png")
...
local function baseDraw(screenx,screeny,scale)
  ...
  love.graphics.setColor(255,255,255,100+155*rate)
...
local function self_open(call,titleString)
  dtime = 0
  title = titleString
  callback = call
end
