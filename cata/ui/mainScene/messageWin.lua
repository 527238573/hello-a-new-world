...
local panel_img = love.graphics.newImage("assets/ui/messageWin.png")
local quads =  suit.createS9Table(panel_img,0,0,32,32,6,6,6,6)
...
local function defaultDraw(x,y,w,h)
  ...
  while(curLine<= lineNum) do
    ...
    if ccolor then
      love.graphics.setColor(ccolor[1],ccolor[2],ccolor[3])
    else
